...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    let paused = false;
    const active = this[i].querySelector('.carousel-inner');
    ...
    document.querySelector('.carousel-prev').addEventListener('mouseenter', () => {
      clearInterval(paused);
    });
    document.querySelector('.carousel-next').addEventListener('mouseenter', () => {
      clearInterval(paused);
    });
    active.addEventListener('mouseleave', () => {
      activateAnimation();
    });
    document.querySelector('.carousel-prev').addEventListener('mouseleave', () => {
      activateAnimation();
    });
    document.querySelector('.carousel-next').addEventListener('mouseleave', () => {
      activateAnimation();
    });
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tab = function () {
  for (let i = 0; i < this.length; i++) {
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).on('click', () => {
      (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).fadeIn(700).addClass('tab-item--active').siblings().removeClass('tab-item--active').closest('.tab').find('.tab-content').removeClass('tab-content--active').eq((0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).index()).addClass('tab-content--active');
    });
  }
};
